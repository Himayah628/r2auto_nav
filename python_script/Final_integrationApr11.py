...
class AutoNav(Node):
    ...
    def travelling_to_table(self, table_no):
        ...
        if(table_no ==5):
            ...
            self.rotatebot(clockwise_angle)
            self.moveforward(0, 0.40)
            self.rotatebot(anticlockwise_angle)
            self.orientation_check(175) #use lidar to confirm
            self.moveforward(0, 0.40) #reach table 5
        else:
            self.rotatebot(clockwise_angle)
            self.moveforward(0, 0.40) #reach table 1
            if(table_no != 1):
                self.rotatebot(clockwise_angle)
                ...
                if(table_no == 6):
                    ...
                    self.rotatebot(anticlockwise_angle)
                    self.orientation_check(175)
                    self.moveforward(0,0.4) #reach table 6
                    ...
                    if(table_no ==2):
                        ...
                        self.rotatebot(clockwise_angle) #reach table 3
                            ...
                            self.moveforward(270,0.5)  #reach table 4
                            self.rotatebot(clockwise_angle)
